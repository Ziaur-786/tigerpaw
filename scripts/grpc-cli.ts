...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/tigerpaw.proto')
...
const tigerpawProto = protoDescriptor.tigerpaw.v1
...
async function main() {
  ...
  const client = new tigerpawProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mTigerpaw gRPC CLI\x1b[0m')
