...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "TIGERPAW Updates [internal-only: Latest CC commits]" : "TIGERPAW Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share TIGERPAW and earn ${formatCreditAmount(reward)} of extra usage` : 'Share TIGERPAW with friends';
  return {
