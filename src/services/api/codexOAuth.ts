...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Tigerpaw now.</p>
    <p>Tigerpaw will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Tigerpaw.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Tigerpaw.</p>
  </body>
</html>`
}
