...
async function makeProjectDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'tigerpaw-wiki-init-'))
  tempDirs.push(dir)
  return dir
}
